"""
Linear Probe - Fixed Version
HuBERT-ECG expects (batch, 1, samples) — single lead input
"""
...
print("="*50)
print("Linear Probe — HuBERT-ECG (Fixed)")
print("="*50)
...
def process_signal(sig, fs):
    ...
    # Use lead I only (first lead) — shape: (5000,)
    lead = sig[:, 0]
...
class ECGDataset(Dataset):
    def __init__(self, X, y):
        # X shape: (N, 5000) → add channel dim → (N, 1, 5000)
